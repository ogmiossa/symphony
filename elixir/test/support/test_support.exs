defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          tracker_required_labels_by_state: %{},
    ...
    tracker_required_labels_by_state = Keyword.get(config, :tracker_required_labels_by_state)
    ...
    sections =
      [
        ...
        "  required_labels_by_state: #{yaml_value(tracker_required_labels_by_state)}",
